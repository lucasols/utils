...
vi.mock('@ls-stack/utils/getAutoIncrementId', () => ({
  getAutoIncrementId: vi.fn(() => Math.floor(Math.random() * 1000000))
}));

vi.mock('@ls-stack/utils/timers', () => ({
  createTimeout: vi.fn((delay: number, callback: () => void) => {
